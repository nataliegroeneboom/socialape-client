...
class Notifications extends Component {
    ...
    onMenuOpen = () => {
        ...
        let unreadNotificationIds =this.props.notifications.filter(not => {
               return !not.read
            }).map(not => not.notificationId);

            this.props.markNotificationsRed(unreadNotificationIds);
    }
...
export default connect(mapStateToProps, {markNotificationsRed})(Notifications); 
